...
BEGIN_MESSAGE_MAP(CtaskingApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CtaskingApp::OnAppAbout)
...
CtaskingApp::CtaskingApp() noexcept
{
	...
	SetAppID(_T("tasking.AppID.NoVersion"));
...
BOOL CtaskingApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_taskingTYPE,
...
// CtaskingApp customization load/save methods

void CtaskingApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CtaskingApp::LoadCustomState()
{
}

void CtaskingApp::SaveCustomState()
{
}
