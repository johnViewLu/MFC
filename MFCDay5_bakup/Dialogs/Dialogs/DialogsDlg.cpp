...
BEGIN_MESSAGE_MAP(CDialogsDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_YEENOCANCEL, &CDialogsDlg::OnYesnocancel)
...
void CDialogsDlg::OnYesnocancel()
{
	...
	int iResults = MessageBox(L"Press the Yes, No, or Cancel button",
		L"Yes, No, Cancle Dialog",
